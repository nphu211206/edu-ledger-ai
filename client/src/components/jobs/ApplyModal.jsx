...
// ===>>> BƯỚC 1: IMPORT LOADING SPINNER CHUẨN <<<===
import { LoadingSpinner } from '../common/FeedbackComponents';
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="p-6 border-t border-gray-700 flex justify-end gap-4">
                        ...
                        <button type="submit" disabled={isLoading} className="py-2 px-6 bg-blue-600 rounded-md hover:bg-blue-500 transition text-white font-bold flex items-center justify-center min-w-[120px]">
                            {/* ===>>> BƯỚC 3: SỬ DỤNG LOADING SPINNER CHUẨN <<<=== */}
                            {isLoading ? <LoadingSpinner size="sm" text="" /> : 'Xác nhận'}
                        </button>
                    </div>
                </form>
            </motion.div>
